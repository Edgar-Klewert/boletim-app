...
export function PathSearchDisableHistory(){
    return(
                ...
                <div className="flex flex-wrap justify-center">
                    {courses.map((course) => (
                        <div key={course.id} className="bg-white shadow-md m-10 w-80 py-1">
                            <Link to={`/academic-record/download-search`} className='block'>
                                <div className="flex flex-col items-center">
                                    <img src={course.imageURL} alt="Imagem do curso" className="block"/>
