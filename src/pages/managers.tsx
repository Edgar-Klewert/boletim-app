        ...
        <div className="mx-auto my-8 grid w-full max-w-7xl grid-cols-3 gap-y-8">
          ...
          >
            <img
              ...
              alt=""
            />
            <span className="font-medium text-white">Adicionar Gerente</span>
          </Link>
          <Link
            to={'#'}
            className="relative flex h-52 w-full max-w-80 justify-end rounded bg-pmpa-default-blue px-6 py-4"
          >
            <img
              ...
              alt=""
            />
            <span className="font-medium text-white">Atualizar Gerente</span>
          </Link>
          <Link
            to={'#'}
            className="relative flex h-52 w-full max-w-80 justify-end rounded bg-pmpa-default-blue px-6 py-4"
          >
            <img
              ...
              alt=""
            />
            <span className="font-medium text-white">Ativar Gerente</span>
          </Link>
          <Link
            to={'#'}
            className="relative flex h-52 w-full max-w-80 justify-end rounded bg-pmpa-default-blue px-6 py-4"
          >
            <img
              ...
              alt=""
            />
            <span className="font-medium text-white">Desativar Gerente</span>
          </Link>
        </div>
      </section>
    </main>
